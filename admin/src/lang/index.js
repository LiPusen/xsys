...
const lang = ['en', 'zh', 'ja'];
// 根据模块去做语言适配
const mods = ['route', 'tips', 'pop', 'p404', 'material', 'media', 'login', 'form', 'board', 'adbbMag', 'activeTable', 'activeMag', 'accountSetting', 'report'];
// ele 公共语言包 和适配语言对齐
...
// 国际化适配
Vue.prototype.$i18nAdapt = function(title) {
